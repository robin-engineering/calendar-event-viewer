...
const mockEvents: RobinEvent[] = [
    ...
    },
    {
      ...
      start_time: '2024-05-22T16:00:00',
      end_time: '2024-05-22T17:00:00',
    ...
    },
    {
      ...
      start_time: '2024-05-17T13:00:00',
      end_time: '2024-05-17T14:00:00',
      location: 'Virtual',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      start_time: '2024-05-20T11:00:00',
      end_time: '2024-05-20T12:00:00',
      location: 'Virtual',
    },
    {
      id: 8,
      ...
      end_time: '2024-05-21T17:00:00',
      location: 'Office Recreation Area',
    }
];

const GetEventsForUserByDateRangeResolver = async (
    _: unknown,
    ...
    return getEventsFromDB(userId, startDateTime, endDateTime);
};
...
const withAuthorization = (
    ...
    const authenticatedUserContext = await getAuthInfo();
